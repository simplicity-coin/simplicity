...
*Setup instructions for a gitian build of Simplicity using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Simplicity
...
- [Building Simplicity](#building-simplicity)
...
Clone the git repositories for simplicity and gitian and then checkout the simplicity version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/simplicity-crypto/simplicity.git
cd simplicity
...
Follow the instructions in [doc/release-process.md](release-process.md) in the simplicity repository
...
To build Simplicity (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the simplicity repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/simplicity/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/simplicity-crypto/simplicity
...
For example:
```bash
URL=https://github.com/crowning-/simplicity.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit simplicity=${COMMIT} --url simplicity=${URL} ../simplicity/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit simplicity=${COMMIT} --url simplicity=${URL} ../simplicity/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit simplicity=${COMMIT} --url simplicity=${URL} ../simplicity/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/simplicity-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/simplicity-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/simplicity-build.assert
```
...
[simplicity/gitian.sigs](https://github.com/simplicity-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
