...
The Simplicity project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/simplicity-project/simplicity/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Simplicity project, and is not to be
confused with overall Simplicity Network Protocol consensus changes.

Whether a pull request is merged into Simplicity rests with the project merge
...
Patches that change Simplicity consensus rules are considerably more involved than
...
Where a patchset proposes to change the Simplicity consensus, it must have been
...
The project leader is the release manager for each Simplicity release.
