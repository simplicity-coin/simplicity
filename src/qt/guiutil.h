...
/** Utility functions used by the Simplicity Qt UI.
 */
namespace GUIUtil
{
...
// Render Simplicity addresses in monospace font
...
// Parse "simplicity:" URI into recipient object, return true on successful parsing
