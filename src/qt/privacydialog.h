...
public:
    ...
    void setZSplControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzSPL_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSPL_clicked();
    void on_pushButtonZSplControl_clicked();
