...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Simplicity"),
     ...
     * override -datadir in the simplicity.conf file in the default data directory
     * (to be consistent with simplicityd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
