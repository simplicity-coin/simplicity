                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSPLPathCustom = GetArg("-zsplbackuppath", "");
    ...
    if(!strzSPLPathCustom.empty()) {
        ui->wallet_customzsplbackuppath->setText(QString::fromStdString(strzSPLPathCustom));
        ui->wallet_customzsplbackuppath_label->setVisible(true);
        ui->wallet_customzsplbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSPLPathCustom.empty()) && nCustomBackupThreshold > 0) {
