...
#ifndef SIMPLICITY_ZSPLWALLET_H
#define SIMPLICITY_ZSPLWALLET_H
...
public:
    CzSPLWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSPL(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSPL(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
