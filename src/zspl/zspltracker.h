...
#ifndef SIMPLICITY_ZSPLTRACKER_H
#define SIMPLICITY_ZSPLTRACKER_H
...
public:
    CzSPLTracker(std::string strWalletFile);
    ~CzSPLTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzSPLWallet* zSPLWallet = NULL);
...
#endif //SIMPLICITY_ZSPLTRACKER_H
