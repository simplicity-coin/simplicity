...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Simplicity simplicity-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  simplicity-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded simplicity transaction") + "\n" +
                               "  simplicity-tx [options] -create [commands]   " + _("Create hex-encoded simplicity transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded simplicity transaction
