...
from fake_stake.base_test import SIMPLICITY_FakeStakeTest

class zSPLValidCoinSpendTest(SIMPLICITY_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zSPLs..." % DENOM_TO_USE)
