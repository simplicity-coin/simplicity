...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/simplicity-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/simplicity-cli.cpp \
           src/simplicity-tx.cpp \
           src/simplicity.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/simplicity.qrc src/qt/simplicity_locale.qrc

TRANSLATIONS += src/qt/locale/simplicity_bg.ts \
                src/qt/locale/simplicity_de.ts \
                src/qt/locale/simplicity_en.ts \
                src/qt/locale/simplicity_es.ts \
                src/qt/locale/simplicity_fi.ts \
                src/qt/locale/simplicity_fr.ts \
                src/qt/locale/simplicity_it.ts \
                src/qt/locale/simplicity_ja.ts \
                src/qt/locale/simplicity_pl.ts \
                src/qt/locale/simplicity_pt.ts \
                src/qt/locale/simplicity_ru.ts \
                src/qt/locale/simplicity_sk.ts \
                src/qt/locale/simplicity_sv.ts \
                src/qt/locale/simplicity_vi.ts \
                src/qt/locale/simplicity_zh_CN.ts \
                src/qt/locale/simplicity_zh_TW.ts
